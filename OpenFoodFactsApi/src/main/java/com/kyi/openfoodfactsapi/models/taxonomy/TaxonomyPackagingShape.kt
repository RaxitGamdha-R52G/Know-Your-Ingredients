...
enum class TaxonomyPackagingShapeField(override val offTag: String) : OffTagged {
    ALL("all"),
    NAME("name"),
    SYNONYMS("synonyms"),
    CHILDREN("children"),
...
class TaxonomyPackagingShape : JsonObject() {
    ...
    companion object {
        ...
        fun fromJson(json: Map<String, Any?>): TaxonomyPackagingShape = TaxonomyPackagingShape().apply {
