...
enum class TaxonomyOriginField(override val offTag: String) : OffTagged {
    ALL("all"),
    NAME("name"),
    SYNONYMS("synonyms"),
    CHILDREN("children"),
...
class TaxonomyOrigin : JsonObject() {
    ...
    companion object {
        ...
        fun fromJson(json: Map<String, Any?>): TaxonomyOrigin = TaxonomyOrigin().apply {
